...
import { File, Download, X, Upload, AlertCircle, FileText, Image, Archive, Cloud, ExternalLink } from 'lucide-react'
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-blue-800 mb-3">
                If you have additional files or files that exceed our size limits, you can upload them to cloud storage services and share the links via messages:
              </p>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {[
                  { name: 'File.io', url: 'https://file.io', description: 'Simple, temporary file sharing' },
                  { name: 'MediaFire', url: 'https://mediafire.com', description: 'Free file hosting service' },
                  { name: 'Google Drive', url: 'https://drive.google.com', description: 'Share from your Google Drive' },
                  { name: 'OneDrive', url: 'https://onedrive.live.com', description: 'Microsoft cloud storage' },
                  { name: 'Dropbox', url: 'https://dropbox.com', description: 'Share via Dropbox links' },
                  { name: 'WeTransfer', url: 'https://wetransfer.com', description: 'Send large files easily' }
                ].map((service) => (
                  <div key={service.name} className="bg-white p-3 rounded border border-blue-200 shadow-sm">
