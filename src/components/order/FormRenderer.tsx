            ...
            {field.options.map((option) => (
              <Label 
                ...
                className={`flex items-start space-x-3 p-4 border-2 rounded-lg cursor-pointer transition-all duration-200 hover:bg-blue-50 hover:border-blue-300 ${
                  value === option.value ? 'bg-blue-50 border-blue-400 ring-2 ring-blue-200' : 'border-gray-200 hover:shadow-sm'
                }`}
              >
                <RadioGroupItem 
                  value={option.value} 
              ...
              return (
                <Label 
                  ...
                  className={`flex items-start space-x-3 p-4 border-2 rounded-lg cursor-pointer transition-all duration-200 hover:bg-green-50 hover:border-green-300 ${
                    isChecked ? 'bg-green-50 border-green-400 ring-2 ring-green-200' : 'border-gray-200 hover:shadow-sm'
                  }`}
                >
                  <Checkbox
                    id={`${field.name}-${option.value}`}
      ...
      <Card>
        ...
        <CardContent>
          <RadioGroup
            ...
            onValueChange={onPricingTierChange}
            required
          >
            {pricingTiers.map((tier) => (
              <Label 
                ...
                className={`flex items-start space-x-3 p-4 border-2 rounded-lg cursor-pointer transition-all duration-200 hover:bg-blue-50 hover:border-blue-300 ${
                  selectedPricingTier === tier.id ? 'bg-blue-50 border-blue-400 ring-2 ring-blue-200' : 'border-gray-200 hover:shadow-sm'
                }`}
              >
                <RadioGroupItem 
                  value={tier.id} 
