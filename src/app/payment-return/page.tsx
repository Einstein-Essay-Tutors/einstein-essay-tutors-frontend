          ...
          <CardContent className="text-center space-y-4">
            ...
            {orderNumber && (
              <p className="font-medium">
                Order{' '}
                <code className="bg-green-100 px-3 py-2 rounded-lg border-2 border-green-300 font-mono text-sm font-bold text-green-800 shadow-sm">
                  {orderNumber}
                </code>{' '}
                is now confirmed!
              </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
      <Card className="w-full max-w-md border-red-200 bg-red-50">
        ...
        <CardContent className="text-center space-y-4">
          <p className="text-red-700">{error || 'There was an error processing your payment.'}</p>
