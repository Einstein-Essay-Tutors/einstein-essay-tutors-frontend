        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              We are a leading academic writing service dedicated to helping students 
              achieve their educational goals through expert writing assistance and personalized support.
            </p>
            <Link href="/order">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto text-gray-600">
              <p className="text-lg leading-relaxed mb-6">
                Einstein Essay Tutors was founded with a simple yet powerful mission: to provide students 
                worldwide with access to high-quality academic writing support. Named after one of history&apos;s 
                greatest minds, we embody the spirit of intellectual curiosity, critical thinking, and 
                academic excellence that Albert Einstein represented.
              </p>
              <p className="text-lg leading-relaxed mb-6">
                Since our inception, we have helped thousands of students navigate the complex world of 
                academic writing. From high school essays to doctoral dissertations, our team of expert 
                writers has the knowledge and experience to assist students at every academic level and 
                ...
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-primary rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-1">1</div>
                      <p className="text-gray-700">Academic credential verification</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-primary rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-1">2</div>
                      <p className="text-gray-700">Writing sample evaluation</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-primary rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-1">3</div>
                      <p className="text-gray-700">Subject knowledge assessment</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-primary rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-1">4</div>
                      <p className="text-gray-700">Communication skills testing</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-primary rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 mt-1">5</div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              We&apos;ve built our reputation on delivering exceptional service and outstanding results.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <blockquote className="text-2xl text-gray-600 italic font-light leading-relaxed">
              ...
              intellectual growth and helping them achieve their educational goals while 
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Join thousands of students who have trusted Einstein Essay Tutors 
