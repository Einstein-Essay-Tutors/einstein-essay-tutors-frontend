        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Oops! The page you're looking for seems to have wandered off. But don't worry – we're
          ...
          <div className="bg-gradient-to-r from-primary/5 to-indigo-50 rounded-2xl p-8 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Our support team is here to help you 24/7. Get assistance with orders, services, or
